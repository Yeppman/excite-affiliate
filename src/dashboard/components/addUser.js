...
class AddUser extends Component {
    ...
    handleSubmit = (values, err) => {
        ...
        const lName =  
        values["kName"] === undefined ? null : values["lName"] ;
        
        const businessName = 
            values['businessNamebusinessName'] === undefined ? null : values['businessNamebusinessName'] ;
        ...
        return (
            ...
            <div className="main">
                ...
                <Form onFinish={this.handleSubmit}>
                    <Form.Item>
                        <h1 style={{fontSize:23}} className="ant-form-text">Add user to list</h1>
                              </Form.Item>
